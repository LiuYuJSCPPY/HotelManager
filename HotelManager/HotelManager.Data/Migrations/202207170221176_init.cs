namespace HotelManager.Data.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        HotelUser_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AccomdationPackage", t => t.accomdationPackageId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.HotelUser_Id)
                .Index(t => t.accomdationPackageId)
                .Index(t => t.HotelUser_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BookAccmodation", "HotelUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.BookAccmodation", "accomdationPackageId", "dbo.AccomdationPackage");
            ...
            DropIndex("dbo.BookAccmodation", new[] { "HotelUser_Id" });
            DropIndex("dbo.BookAccmodation", new[] { "accomdationPackageId" });
